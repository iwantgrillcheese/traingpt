...
export default function RaceFinderPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-zinc-50 px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-3xl rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <input
          ...
          className="mt-5 w-full rounded-full border border-zinc-200 bg-white px-4 py-2.5 text-sm text-zinc-900 shadow-sm outline-none placeholder:text-zinc-400 focus:border-zinc-300 focus:ring-2 focus:ring-zinc-100"
        />

        <div className="mt-4 space-y-3">
          {filteredLocalRaces.map((race) => (
            <div key={race.id} className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <div className="text-sm font-medium text-zinc-900">{race.name}</div>
