...
type CoachingErrorProps = {
  error: Error & { digest?: string };
  reset: () => void;
};

export default function CoachingError({ error, reset }: CoachingErrorProps) {
  useEffect(() => {
      ...
      <div className="mx-auto flex min-h-[70vh] max-w-xl items-center justify-center">
        <section className="w-full rounded-3xl border border-zinc-200 bg-white p-6 text-center shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-zinc-600">
            Your coach dashboard hit an unexpected error. Try again, or jump to your schedule while
            we recover this view.
          </p>
